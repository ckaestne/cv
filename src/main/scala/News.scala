...
object News {
    ...
    case class NewsItem(date: LocalDate, title: String, body: NodeSeq) {
        def getID() = DateTimeFormatter.ofPattern("yyyy-MM-dd").format(date)+"_"+title.replaceAll("[\\W]|_", "_")
    }
...
//          <span>I'm looking for two postdocs, one each for (a) a project on performance analysis of configurable systems and (b) a project on software supply chain security. 
 //           See our ICSE'22 paper "On debugging..." and our ICSE'21 paper "Containing malicious package updates..." as examples of the work in these two areas.
   //         Some research experience in either empirical software engineering or the specific field is useful. Email me if interested for more details.</span>) ::
        ...
        NewsItem(LocalDate.of(2020, 9, 18), "State of the Source Talk: Analyzing Tens of Terabytes of Public Trace Data & Open Source Sustainabilty",
        ...
        NewsItem(LocalDate.of(2020, 9, 11), "What the Fork? Shurui Zhou on the Sustain Podcast",
        ...
        NewsItem(LocalDate.of(2020, 5, 9), "Talk on Software Engineering for AI-Enabled Systems",
        ...
        NewsItem(LocalDate.of(2020, 3, 8), "Machine Learning is Requirements Engineering — On the Role of Bugs, Verification, and Validation in Machine Learning",
        ...
        NewsItem(LocalDate.of(2020, 1, 31), "Software Engineering for ML - An Annotated Bibliography",
        ...
        NewsItem(LocalDate.of(2019, 9, 20), "SPLC Most Influencial Paper Award",
        ...
        NewsItem(LocalDate.of(2019, 5, 20), "Feature Flags vs Configuration Options",
        ...
        NewsItem(LocalDate.of(2017, 6, 29), "Differential Testing for KConfigReader",
        ...
        NewsItem(LocalDate.of(2017, 6, 5), "jsconf.eu talk: How to Break an API",
        ...
        NewsItem(LocalDate.of(2016, 9, 20), "Ecosystem Survey",
        ...
        NewsItem(LocalDate.of(2016, 7, 13), "Postdoc position available",
        ...
        NewsItem(LocalDate.of(2016, 4, 16), "On the ICSE 2017 Author Limit Policy",
        ...
        NewsItem(LocalDate.of(2016, 4, 15), "NSF Career Award",
        ...
        NewsItem(LocalDate.of(2016, 3, 29), "ASE 2015 Doctoral Symposium Keynote",
        ...
        NewsItem(LocalDate.of(2016, 1, 24), "FOSD Meeting 2016",
        ...
        NewsItem(LocalDate.of(2015, 3, 13), "The Love/Hate Relationship with the Preprocessor at ECOOP 2015",
        ...
        NewsItem(LocalDate.of(2014, 7, 2), "Teaching Software Construction with Travis CI",
        ...
        NewsItem(LocalDate.of(2014, 5, 10), "FOSD Meeting 2015",
        ...
        NewsItem(LocalDate.of(2014, 3, 27), "Research Experiences for Undergraduates in Software Engineering",
        ...
        NewsItem(LocalDate.of(2014, 2, 24), "Huffington Post Article",
        ...
        NewsItem(LocalDate.of(2014, 1, 16), "Going to Hyderabad",
        ...
        NewsItem(LocalDate.of(2013, 10, 23), "New students",
        ...
        NewsItem(LocalDate.of(2013, 8, 16), "Variability Mining paper accepted",
        ...
        NewsItem(LocalDate.of(2013, 6, 28), "NSF Grant: Reverse Engineering Variability Implementations",
        ...
        NewsItem(LocalDate.of(2013, 4, 17), "Book available for preorder: Feature-Oriented Software Product Lines",
        ...
        NewsItem(LocalDate.of(2013, 3, 21), "TypeChef release 3.4",
        ...
        NewsItem(LocalDate.of(2013, 2, 17), "Dagstuhl Variability Analysis and FOSD",
        ...
        NewsItem(LocalDate.of(2013, 2, 12), "Book: Feature-Oriented Software Product Lines",
        ...
        NewsItem(LocalDate.of(2012, 9, 30), "GPCE 2013",
        ...
        NewsItem(LocalDate.of(2012, 9, 7), "FOSD and GPCE in Dresden",
        ...
        NewsItem(LocalDate.of(2012, 8, 25), "Moving to CMU",

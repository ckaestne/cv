package de.stner.cv
import de.stner.cv.Coauthors.{Bogart, Kaestner, Trockman, Vasilescu}
...
object CVMedia {
    ...
    val jsconf17Talk = Youtube("How to Break an API: How Community Values Influence Practices | JSConf EU 2017", "xJHeHCZtmAU", LocalDate.of(2017, 5, 31))

    val infographicBadges = Website("Infographic: npm badges", URL("https://cmustrudel.github.io/announcement/badges"), LocalDate.of(2018, 3, 18), List(Trockman, Kaestner, Bogart))
    val infographicDonations = Website("Infographic: Donations in Open Source", URL("https://cmustrudel.github.io/announcement/donations"), LocalDate.of(2020, 6, 18), List(Trockman, Kaestner, Bogart))
    ...
    val ccTalk20 = Youtube("Software Engineering for ML-Enabled Systems", "9_xeTHaTcCQ", LocalDate.of(2020,4,28))
    val semlaTalk20 = Youtube("Engineering AI-Enabled Systems with Interdisciplinary Teams", "", LocalDate.of(2020,6,18))
    val seetTalk20 = Youtube("Teaching Software Engineering for AI-Enabled Systems", "Nk0Sy6Sx3IY", LocalDate.of(2020,6,5))

    val seaiMedium20MLisRE = MediumBlog("Machine Learning is Requirements Engineering", URL("https://medium.com/ckaestne/machine-learning-is-requirements-engineering-8957aee55ef4"), LocalDate.of(2020,3,8))

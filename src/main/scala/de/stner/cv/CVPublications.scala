...
object CVPublications {
    ...
    Map(PDF->URL("http://wwwiti.cs.uni-magdeburg.de/~ckaestne/sdsoa2008.pdf")),
    ...
    Publication(
       Seq(Apel, Christian Lengauer, Bernhard M{\"o}ller, Kaestner),
    ...
    .publisher("Springer-Verlag}, address={Berlin/Heidelberg, Germany"),
       month=jul,
    .volume(5140)
    Range(36,50),
    Map(PDF->URL("http://wwwiti.cs.uni-magdeburg.de/~ckaestne/AMAST08.pdf")),
    Map(DOI->URL("http://dx.doi.org/10.1007/978-3-540-79980-1_4")),
    .year(2008)
    ...
    Map(PDF->URL("http://wwwiti.cs.uni-magdeburg.de/~ckaestne/ASE08.pdf"))
    }
    ...
    Publication(
       Seq(Chang Hwan Peter Kim, Kaestner, Batory),
    ...
    Map(ACM->URL("http://dl.acm.org/authorize?036803")),
    Range(23,34),
    .note("Acceptance rate: 29\,\% (16/55)"),
    Map(PDF->URL("http://wwwiti.cs.uni-magdeburg.de/~ckaestne/GPCE08-Kim.pdf")),
    """
    ...
    Map(ACM->URL("http://dl.acm.org/authorize?036826")),
    .location("Nashville, TN, USA"),
       publisher=ACM,address=ACMAddr,
    .note("Acceptance rate: 29\,\% (16/55)"),
    Map(PDF->URL("http://wwwiti.cs.uni-magdeburg.de/~ckaestne/GPCE08-FA.pdf")),
    ...
    Map(ACM->URL("http://dl.acm.org/authorize?036811")),
       publisher=ACM,address=ACMAddr,
    .note("Acceptance rate: 29\,\% (16/55)"),
       crosscite={extended by \cite{AKGL:JASE10}},
    Map(PDF->URL("http://wwwiti.cs.uni-magdeburg.de/~ckaestne/GPCE08-FFJ.pdf")),
    ...
    Publication(
       Seq(Mario Pukall, Kaestner, Saake),
    ...
    Publication(
       Seq(Norbert Siegmund, Marko Rosenm{\"u}ller, Kuhlemann, Kaestner, Saake),
    ...
    Publication(
     Seq(Marko Rosenm{\"u}ller, Norbert Siegmund, Syed Saif ur Rahman, Kaestner),
    ...
    .publisher("University of Passau},address={Passau, Germany"),
    Range(13,18),
     nonumber = {MIP-0802},
    ...
    Publication(
     "{FeatureHouse}: Language-Independent, Automated Software Composition",
           Seq(Apel, Christian K\"{a}stner, Christian Lengauer),
    ...
    Publication(
     "Reasoning about Edits to Feature Models",
           Seq(Thomas Th{\"u}m, Batory, Christian K\"{a}stner),
           booktitle={Proceedings of the 31th International Conference on Software Engineering (ICSE)},
    .year(2009)month=may,location={Vancouver, Canada},
       publisher = IEEE,address=IEEEAddr,
    .selected(),
    ...
    Publication(
       Seq(Apel, Kaestner, Armin Gr{\"o}{\ss}linger, Christian Lengauer),
    ...
    Publication(
     "Bridging the Gap between Variability in Client Application and Database Schema",
       Seq(Norbert Siegmund, Kaestner, Marko Rosenm{\"u}ller, Florian Heidenreich, Apel, Saake),
    ...
    Publication(
     "SQL \`{a} la Carte -- Toward Tailor-made Data Management",
       Seq(Marko Rosenm{\"u}ller, Kaestner, Norbert Siegmund, Sagar Sunkle, Apel, Leich, Saake),
       booktitle={Proceedings 13. GI-Fachtagung Datenbanksysteme f{\"u}r Business, Technologie und Web (BTW)},
    .year(2009)month=mar,
    .series("Lecture Notes in Informatics},volume={P-144"),
       isbn={978-3-88579-238-3},
    ...
    Publication(
     "{FeatureIDE}: Tool Framework for Feature-Oriented Software Development",
           Seq(Christian K\"{a}stner, Thomas Th{\"u}m, Saake, Feigenspan, Leich, Fabian Wielgorz, Apel),
           booktitle={Proceedings of the 31th International Conference on Software Engineering (ICSE)},
    ...
    Range(9,26),
             publisher=Springer,address=SpringerAddr,
    .location("Zurich, Switzerland},issn={0302-9743},isbn={978-3-642-02654-6},doi={10.1007/978-3-642-02655-3_3"),
    ...
    Publication(
       Seq(Kaestner, Apel, Syed Saif ur Rahman, Marko Rosenm{\"u}ller, Batory, Saake),
    ...
    Publication(
       Seq(Mario Pukall, Kaestner, Sebastian G{\"o}tz, Walter Cazzola, Saake),
    ...
    Publication(
       Seq(Apel, J{\"o}rg Liebig, Christian Lengauer, Kaestner, William R. Cook),
    ...
    Publication(
     "An Analysis of the Variability in Forty Preprocessor-Based Software Product Lines",
           Seq(J{\"o}rg Liebig, Apel, Christian Lengauer, Christian K\"{a}stner, Michael Schulze),
    ...
    Publication(
       Seq(Apel, Wolfgang Scholz, Christian Lengauer, Kaestner),
    ...
    Publication(
       editor={Apel and Batory and Krzysztof Czarnecki and Florian Heidenreich and Kaestner and Oscar Nierstrasz},
    ...
    .year(2011)month=jan,location={Namur, Belgium},
    Range(137,140},isbn={978-1-4503-0570-9),
    ...
    Publication(
       Seq(Kaestner, Apel, Thomas Th{\"u}m, Saake),
    ...
    Publication(
       Seq(Mario Pukall, Alexander Grebhahn, Schr\"{o}ter, Reimar, Kaestner, Walter Cazzola, Sebastian G{\"o}tz),
    ...
    Publication(
       Seq(Apel, Florian Heidenreich, Kaestner, Marko Rosenm{\"u}ller),
    ...
    Publication(
       Seq(Norbert Siegmund, Marko Rosenm{\"u}ller, Kaestner, Paolo G. Giarrusso, Apel, Sergiy Kolesnikov),
    ...
    Publication(
       Seq(Thomas Th{\"u}m, Kaestner, Sebastian Erdweg, Norbert Siegmund),
    ...
    Publication(
     ...
     "{Virtuelle Trennung von Belangen}",
       publisher=GI,series=LNI,volume={D-11},
    Range(121,130),
    ...
    Publication(
       Seq(Norbert Siegmund, Marko Rosenm{\"u}ller, Kuhlemann, Kaestner, Apel, Saake),
    ...
    Publication(
       Seq(Apel, J{\"o}rg Liebig, Benjamin Brandl, Christian Lengauer, Kaestner),
    ...
    Publication(
       Seq(Mario Pukall, Kaestner, Walter Cazzola, Sebastian G{\"o}tz, Alexander Grebhahn, Reimar Schr\"oter, Saake),
    ...
    Publication(
       Seq(Norbert Siegmund, Sergiy S. Kolesnikov, Kaestner, Apel, Batory, Marko Rosenm{\"u}ller, Saake),

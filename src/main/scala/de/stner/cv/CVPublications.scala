...
object CVPublications {
  ...
  val Sobernig = Person("Stefan", "Sobernig")
  val Senkaya = Person("Semah", "Senkaya")
  val Passos = Person("Leonardo", "Passos")
  val Wasowski = Person("Andrzej", "Wąsowski")
  val Guo = Person("Jianmei", "Guo")
  val Hunsen = Person("Claus", "Hunsen")
  ...
  and guides to use the right mechanism for the right problem."""
    ...
    InProceedings(
      ...
      """
        ...
        XML languages.                                """).
      note("**Distinguished Paper Award**").topic(dsl),

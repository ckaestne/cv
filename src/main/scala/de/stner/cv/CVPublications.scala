    ...
    and advice mechanisms by analysing three AspectJ case studies.""").topic(aop, fop),
     ...
     program, which is a much stronger SC property.""").
      ...
      in order to be ready for superimposition.""").selected().
        ...
        booktitle = {
        Proceedings of the 8 th International Conference on Generative Programming and Component Engineering (GPCE)
        },
        .year (2009)
        month = oct,
        .location ("Denver, CO, USA"),
        publisher = ACM, address = ACMAddr,
        Map (ACM -> URL ("http://dl.acm.org/authorize?131383") ),
        .note ("Acceptance rate: 31\,\% (19/62)"),
        .isbn ("978-1-60558-828-5"),
        Range (177, 185),
        Map (DOI -> URL ("http://doi.acm.org/10.1145/1621607.1621634") ),
        Map (PDF -> URL ("http://wwwiti.cs.uni-magdeburg.de/~mkuhlema/publications/GPCE09.pdf") ),
        """
        ...
        """
        Physical separation with

        class refinements

        and method refinements \ `{a} la AHEAD and virtual separation using annotations \` {
        a
        } la \ emph {
        \# ifdef
        ...
        Map (PDF -> URL ("http://wwwiti.cs.uni-magdeburg.de/~ckaestne/GPCE09-LJAR.pdf") )
        }
        ...
        Publication(
           Seq(Apel, J{\"o}rg Liebig, Kaestner, Kuhlemann, Leich),
        ...
        oriented modifiers, typically provided
        ...
        Map (DOI -> URL ("http://doi.acm.org/10.1145/1629716.1629723") ),
        Range (27, 34)
        }
        ...
        booktitle = {
        Proceedings of the First Workshop on Feature - Oriented Software Development (FOSD)
        },
        publisher = ACM, address = ACMAddr,
        .location ("Denver, CO, USA"),
        .isbn ("978-1-60558-567-3"),
        month = oct, year = 2009,
        Map (DOI -> URL ("http://doi.acm.org/10.1145/1629716.1629728") ),
        """
        ...
        Publication(
           Seq(Pukall, Kaestner, Sebastian G{\"o}tz, Walter Cazzola, Saake),
        ...
        Publication(
         "{Virtuelle Trennung von Belangen (Pr{\"a}prozessor 2.0)}",
           Seq(Kaestner, Apel, Saake),
           booktitle={Software Engineering 2010 -- Fachtagung des GI-Fachbereichs Softwaretechnik},
        .year(2010)month=feb,
        """
        Bedingte Kompilierung mit Pr {
        \ "a}prozessoren wie \emph{cpp} ist ein einfaches, aber wirksames Mittel zur Implementierung von Variabilit{\"a}t in Softwareproduktlinien.
        Durch das Annotieren von Code - Fragmenten mit \ emph {
        \# ifdef
        } und \ emph {
        \# endif
        } k {
        \ "o}nnen verschiedene Programmvarianten mit oder ohne diesen Fragmenten generiert werden. Obwohl Pr{\"a}prozessoren h{\"a}ufig in der Praxis verwendet werden, werden sie oft f{\"u}r ihre negativen Auswirkungen auf  Codequalit{\"a}t und Wartbarkeit kritisiert. Im Gegensatz zu modularen Implementierungen, etwa mit Komponenten oder Aspekte, vernachl{\"a}ssigen Pr{\"a}prozessoren die Trennung von Belangen im Quelltext, sind anf{\"a}llig f{\"u}r subtile Fehler und verschlechtern die Lesbarkeit des Quellcodes.
        Wir zeigen, wie einfache Werkzeugunterst {
        \ "u}tzung diese Probleme adressieren und zum Teil beheben bzw.\ die Vorteile einer modularen Implementierung emulieren kann. Gleichzeitig zeigen wir Vorteile von Pr{\"a}prozessoren wie Einfachheit und Sprachunabh{\"a}ngigkeit auf.
        },
        ...
        Publication (
        Seq (Apel, J {
        \ "o}rg Liebig, Lengauer, Kaestner, William R. Cook),
        "Semistructured Merge in Revision Control Systems",
        booktitle = {
        Proceedings of the Fourth International Workshop on Variability Modelling of Software - intensive Systems (VaMoS)
        },
        ...
        Publication(
         "An Analysis of the Variability in Forty Preprocessor-Based Software Product Lines",
               Seq(J{\"o}rg Liebig, Apel, Lengauer, Kaestner, Michael Schulze),
               booktitle={Proceedings of the 32nd International Conference on Software Engineering (ICSE)},
        .year(2010)month=may,location={Cape Town, South Africa},
        .selected(),
           publisher=ACM,address=ACMAddr,
        """
        ...
        Map (ACM -> URL ("http://dl.acm.org/authorize?369011") ),
        Map (DOI -> URL ("http://doi.acm.org/10.1145/1806799.1806819") ),
        }
        ...
        Map (PDF -> URL ("http://wwwiti.cs.uni-magdeburg.de/iti_db/publikationen/ps/auto/AKGL:JASE10.pdf") ),
        Map (DOI -> URL ("http://www.springerlink.com/openurl.asp?genre=article&id=doi:10.1007/s10515-010-0066-8") ),
        """
        ...
        Publication(
           Seq(Apel, Lengauer, Bernhard M{\"o}ller, Kaestner),
         "An Algebraic Foundation for Automatic Feature-Based Program Synthesis",
           journal={Science of Computer Programming (SCP)},
        .year(2010)
        .selected(),
        Map(DOI->URL("http://dx.doi.org/10.1016/j.scico.2010.02.001")),
        Map(PDF->URL("http://wwwiti.cs.uni-magdeburg.de/iti_db/publikationen/ps/auto/ALMK:SCP10.pdf")),
        ...
        Publication (
        Seq (Feigenspan, Kaestner, Mathias Frisch, Raimund Dachselt, Apel),
        "Visual Support for Understanding Product Lines",
        booktitle = {
        Proceedings of the 18 th International Conference on Program Comprehension (ICPC)
        },
        .year (2010)
        Range (34, 35),
        publisher = IEEE, address = IEEEAddr,
        Map (DOI -> URL ("http://dx.doi.org/10.1109/ICPC.2010.15") ),
        Map (PDF -> URL ("http://www.informatik.uni-marburg.de/~kaestner/icpc2010_demo.pdf") ),
        .issn ("1063-6897"),
        ...
        Publication(
           Seq(Sandro Schulze, Apel, Kaestner),
        ...
        oriented mechanisms are known to
        ...
        Publication (
        Seq (Apel, Wolfgang Scholz, Lengauer, Kaestner),
        "Dependences and Interactions in Feature-Oriented Design",
        booktitle = {
        Proceedings of the 21 st IEEE International Symposium on Software Reliability Engineering (ISSRE)
        },
        .year (2010)
        month = nov,
        ...
        Publication(
           Seq(Apel, Sergiy Kolesnikov, J{\"o}rg Liebig, Kaestner, Kuhlemann, Leich),
        Map(DOI->URL("http://dx.doi.org/10.1016/j.scico.2010.07.005")),
        ...
        Map (ACM -> URL ("http://dl.acm.org/authorize?315789") ),
        booktitle = {
        Proceedings of the Second Workshop on Feature - Oriented Software Development (FOSD)
        },
        publisher = ACM, address = ACMAddr,
        .location ("Eindhoven, The Netherlands"),
        ...
        Publication(
           Seq(Andy Kenner, Kaestner, Steffen Haase, Leich),
        ...
        \ emph {
        TypeChef
        }, we build a similar type checker for product lines written
        in C that implements variability with \ emph {
        \# ifdef
        } directives of the
        ...
        preprocessor, including lexical macros and unrestricted use of \ emph {
        \# ifdef
        }
        directives.In this paper, we describe the problems faced and our
        progress to solve them with \ emph {
        TypeChef
        }.Although \ emph {
        TypeChef
        } is still
        ...
        the open - source web server \ emph {
        Boa
        } with potentially $2 ^ {
        110
        } $ variants,
        ...
        Map (ACM -> URL ("http://dl.acm.org/authorize?315774") ),
        }
        ...
        Seq (Kaestner, Paolo G.Giarrusso, Klaus Ostermann),
        booktitle = {
        Proceedings of the Fifth International Workshop on Variability Modelling of Software - intensive Systems (VaMoS)
        },
        .year (2011) month = jan, location = {
        Namur, Belgium
        },
        Range (137, 140
        }, isbn = {
        ...
        publisher = ACM, address = ACMAddr,
        Map (ACM -> URL ("http://dl.acm.org/authorize?468359") ),
        """
        ...
        Map(HTTP->URL("http://www.informatik.uni-marburg.de/~kaestner/vamos11.pdf")),
        }

        Publication(
           Seq(J{\"o}rg Liebig, Kaestner, Apel),
        ...
        Map (ACM -> URL ("http://dl.acm.org/authorize?473237") ),
        }



        Publication (
        Seq (Kaestner, Apel, Thomas Th {
        \ "u}m, Saake),
        ...
        Publication(
           Seq(Pukall, Alexander Grebhahn, Schr\"{o}ter, Reimar, Kaestner, Walter Cazzola, Sebastian G{\"o}tz),
        ...
        Publication(
           Seq(Michael Stengel, Feigenspan, Mathias Frisch, Kaestner, Apel, Raimund Dachselt),
        ...
        Publication(
           Seq(Feigenspan, Michael Schulze, Maria Papendieck, Kaestner, Raimund Dachselt, Veit K{\"o}ppen, Mathias Frisch),
        ...
        Seq (Klaus Ostermann, Paolo G.Giarrusso, Kaestner, Tillmann Rendel),
        booktitle = {
        Proceedings of the 25 th European Conference on Object - Oriented Programming (ECOOP)
        },
        ...
        Map(HTTP->URL("http://www.informatik.uni-marburg.de/~kaestner/ecoop11.pdf")),
        ...
        Publication(
           Seq(Siegmund, Rosenmueller, Kaestner, Paolo G. Giarrusso, Apel, Sergiy Kolesnikov),
        ...
        Publication (
        Seq (Thomas Th {
        \ "u}m, Kaestner, Sebastian Erdweg, Siegmund),
        "Abstract Features in Feature Modeling",
        booktitle = {
        Proceedings of the 15 th International Software Product Line Conference (SPLC)
        },
        .year (2011) month = aug,
        publisher = IEEE, ADDRESS = IEEEAddr,
        .location ("Munich"),
        ...
        Publication(
           Seq(Feigenspan, Apel, J{\"o}rg Liebig, Kaestner),
        ...
        publisher = GI, series = LNI, volume = {
        D - 11
        },
        Range (121, 130),
        booktitle = {
        ...
        http = {
        http :// www.springerlink.com / content / ax788q46h1702j34 /
        },
        Map (DOI -> URL ("10.1007/s11219-011-9152-9") ),
        }
        ...
        Publication(
           Seq(Sebastian Erdweg, Tillmann Rendel, Kaestner, Klaus Ostermann),
        ...
        Publication (
        Seq (Kaestner, Paolo G.Giarrusso, Tillmann Rendel, Sebastian Erdweg, Klaus Ostermann, Thorsten Berger),
        ...
        Publication(
         "{FeatureCommander}: Colorful \#ifdef World",
           Seq(Feigenspan, Maria Papendieck, Kaestner, Mathias Frisch, Raimund Dachselt),
        ...
        Publication(
         "The Road to Feature Modularity?",
           Seq(Kaestner, Apel, Klaus Ostermann),
        ...
        two notions of modularity, \ emph {
        cohesion
        } without interfaces
        and \ emph {
        information hiding
        } with interfaces, and point out the
        ...
        Kaestner and Klaus Ostermann and Eelco Visser
        },
        ...
        Publication(
           Seq(Kaestner, Alexander Dreiling, Klaus Ostermann),
        ...
        However, adopting a product - line approach poses a major challenge and significant risks, since typically legacy code must be migrated toward a product line.Our aim is to lower the adoption barrier by providing semiautomatic tool support --- called \ emph {
        variability mining
        } --- to support developers in locating, documenting, and extracting implementations of product - line features from legacy code.Variability mining combines prior work on concern location, reverse engineering, and variability - aware type systems, but is tailored specifically for the use in product lines.Our work extends prior work in three important aspects: (1) we provide a \ emph {
        consistency indicator
        } based on a variability - aware type system, (2) we mine features at a \ emph {
        fine level of granularity
        }, and (3) we exploit \ emph {
        domain knowledge
        } about the relationship between features when available.With a quantitative study, we demonstrate that variability mining can efficiently support developers in locating features.
        },
        ...
        Publication (
        Seq (Pukall, Kaestner, Walter Cazzola, Sebastian G {
        ...
        """
        Superimposition is a composition technique that has been applied successfully in many areas of software development.Although superimposition is a general - purpose concept, it has been (re) invented and implemented individually for various kinds of software artifacts.We unify languages and tools that rely on superimposition by using the language - independent model of \ emph {
        feature structure trees
        } (FSTs).On the basis of the FST model, we propose a general approach to the composition of software artifacts written in different languages.Furthermore, we offer a supporting framework and tool chain, called \ fh.We use attribute grammars to automate the integration of additional languages.In particular, we have integrated Java, C \#, C, Haskell, Alloy, and JavaCC.A substantial number of case studies demonstrate the practicality and scalability of our approach and reveal insights into the properties that a language must have in order to be ready for superimposition.We discuss perspectives of our approach and demonstrate how we extended \ fh with support for XML languages (in particular, XHTML, XMI / UML, and Ant) and alternative composition approaches (in particular, aspect weaving).Rounding off our previous work, we provide here a holistic view of the \ fh approach based on rich experience with numerous languages and case studies and reflections on several years of research.
        },
        ...
        Publication (
        Seq (Feigenspan, Michael Schulze, Maria Papendieck, Kaestner, Raimund Dachselt, Veit K \ "oppen, Mathias Frisch, Saake),
        ...
        Publication(
           Seq(Feigenspan, Kaestner, Apel, J{\"o)rg Liebig, Michael Schulze, Raimund Dachselt, Maria
        Papendieck and Leich and Saake},

...
object CVTheses {
    ...
    val advisedTheses: Seq[AThesis] = Seq(
        ...
        Thesis(
            ...
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesisthuem.pdf"),
        ...
        Thesis(
            ...
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesisfeigenspan.pdf")
        ),
        ...
        Thesis(
            ...
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesiskegel.pdf")
        ),
        ...
        GermanThesis(
            ...
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesisleminh.pdf")
        ),
        ...
        GermanThesis(
            ...
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesisrosenthal.pdf")
        ),
        Thesis(
            Person("Janet","Feigenspan"),
            "Empirical Comparison of FOSD Approaches Regarding Program Comprehension -- A Feasibility Study",
            MD, (8, 2009), Diplomarbeit,
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesisfeigenspan_diplom.pdf"),
        ...
        GermanThesis(
            ...
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesisschulze.pdf")
        ),
        ...
        GermanThesis(
            ...
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesisbecker.pdf")
        ),
        GermanThesis(
            ...
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesisdreiling.pdf"),
            "A journal paper about the results is currently under review"
        ),
        GermanThesis(
            Person("Andy","Kenner"),
            "Statische Referenzanalyse in C-Pr{ä}prozessor-konfigurierten Anwendungen",
            "Static Reference Analysis of Implementations with C-Preprocessor Variability",
            MD, (8, 2010), Diplomarbeit,
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesiskenner.pdf"),
        ...
        Thesis(
            ...
            new URL("http://www.informatik.uni-marburg.de/~kaestner/thesishaase.pdf")
        ),
